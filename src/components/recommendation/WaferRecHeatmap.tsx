...
import { generateWaferRecHeatmap } from "@/lib/recommendationData";
...
export function WaferRecHeatmap() {
  const heatData = useMemo(() => generateWaferRecHeatmap(12, 16), []);
...
export function CoverageHeatmapMini() {
  const heatData = useMemo(() => generateWaferRecHeatmap(10, 14), []);
